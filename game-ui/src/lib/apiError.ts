...
export const USER_MESSAGES: Record<ApiErrorCode, string> = {
  ...
  ARCHIVE_INVALID_DOSSIER: 'Choose three different undocumented cards.',
  ARCHIVE_CARD_INELIGIBLE: 'One of those cards can no longer be documented.',
  ARCHIVE_PASS_NOT_FOUND: 'That Archive Pass is no longer available.',
