...
For a product or design request (economy, auction, shop, progression, lore, story, and similar), run `npm run brain:retrieve -- "<user request>"` and read every `Read now` vault note before proposing a solution.
