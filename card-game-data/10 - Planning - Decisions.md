...
- Завершення сету в MVP не дає валютної нагороди, ключів або нових карт.
  ...
  ширину пулу.
- Ціна та odds Cinderbound Cache не вважаються затвердженими, доки модель не
  порівняє EV і темп у нової, середньої та майже повної колекції. Новий
  цільовий шлях не можна додати як «просто ще один кейс».
